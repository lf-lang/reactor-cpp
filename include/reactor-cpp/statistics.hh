...
public:
  ...
  static auto reactions() { return reactions_.load(std::memory_order_acquire); }
  static auto actions() { return actions_.load(std::memory_order_acquire); }
  static auto ports() { return ports_.load(std::memory_order_acquire); }
  static auto processed_events() { return processed_events_.load(std::memory_order_acquire); }
  static auto processed_reactions() { return processed_reactions_.load(std::memory_order_acquire); }
  static auto triggered_actions() { return triggered_actions_.load(std::memory_order_acquire); }
  static auto set_ports() { return set_ports_.load(std::memory_order_acquire); }
  static auto scheduled_actions() { return scheduled_actions_.load(std::memory_order_acquire); }
